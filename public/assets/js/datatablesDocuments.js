$(document).ready(function () {
    ...
    let radioButtonsDocument = `
        <div class="me-3">
            ...
            <label class="me-1"><input type="radio" name="filterDocument" value="pengajuanrev"> Pengajuan Revisi</label>
        </div>
    `;
    ...
    $('input[name="filterDocument"]').on('change', function () {
        ...
        if (filterValue === "all") {
            ...
            labelText = "Menampilkan: Kadaluarsa";
        }else if (filterValue === "pengajuanrev") {
            tableDocument.column(3).search("Pengajuan Revisi", true, false).draw();
            labelText = "Menampilkan: Kadaluarsa";
        }
