            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-end mb-1">
                        <a href="/manager/update_dokumen/forms" class="btn btn-admin d-flex align-items-center">
                        ...
                        <table id="myTable" class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="/manager/revisi_dokumen/forms" class="btn btn-sm btn-admin">Revisi</a></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>DOC-002</td>
