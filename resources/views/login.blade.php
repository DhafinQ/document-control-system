...
<head>
  ...
  <style>
    ...
    .radial-gradient {
      margin: 0;
      padding: 0;
      background-image: url('{{ asset('assets/images/backgrounds/bglogin.png') }}'); /* Path ke gambar */
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form>
                  ...
                  <a href="/admin" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Masuk</a>
                  </div>
                </form>
              </div>
            </div>
