            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex mb-1">
                        ...
                        @endcanany
                        <a href="{{route('document_revision.show-file',['filename' => $document->currentRevision->latestRevision($document->id)->file_path ])}}" class="btn {{$is_active ? 'btn-admin' : 'btn-danger'}} d-flex align-items-center ms-2" target="blank">
