...
Route::get('/manager/dokumen_aktif', function () {
    return view('/manager/dokumen_aktif');
});

Route::get('/manager/dokumen_aktif/add', function () {
    return view('/manager/dokumen_aktif_add');
});

Route::get('/manager/dokumen_aktif/edit', function () {
    return view('/manager/dokumen_aktif_edit');
});
